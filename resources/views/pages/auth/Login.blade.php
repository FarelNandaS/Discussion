    ...
    <div class="card w-full max-w-md min-w-[320px] md:min-w-100 bg-base-100 shadow-xl relative">
        ...
        <div class="card-body pt-12">
            <div class="text-center mb-6">
                ...
                <p class="text-sm text-base-content/70 mt-2">Please enter your details to sign in</p>
            </div>
            ...
            <form action="{{ route('login-attempt') }}" method="post" class="space-y-4">
                ...
                <div class="flex justify-between items-center mt-2">
                    ...
                    <a href="{{ route('forgot-password') }}" class="link link-primary link-hover text-sm font-medium">
                        Forgot password?
                    </a>
                </div>

                @if (session('error'))
                    <div class="alert alert-error shadow-sm py-2 text-sm mt-2">
                ...
                <div class="flex flex-col gap-3 mt-6">
                    ...
                    <div class="divider text-xs opacity-50 uppercase">Or continue with</div>
            ...
            <div class="text-center mt-6">
                <p class="text-sm">
                    ...
                    <a href="/register" class="link link-primary font-bold">Register</a>
                </p>
            </div>
        </div>
    </div>
